          ...
          {currentStep === 2 && (
            <div className="space-y-6">
              <div className="flex items-center justify-between">
                ...
                <button
                  onClick={addItem}
                  className="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-lg text-white bg-blue-600 hover:bg-blue-700"
                >
                    ...
                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                      <div className="lg:col-span-2">
                        ...
                        <div className="mt-1 relative">
                          <input
                            type="text"
                            placeholder={item.itemName ? `${item.itemCode} - ${item.itemName}` : "Search items..."}
                      ...
                      <div>
                        ...
                        <div className="mt-1 flex">
                          <input
                            type="number"
                            min="1"
                            className={`w-full px-3 py-2 rounded-l-lg border border-gray-300 focus:ring-2 focus:ring-orange-500 focus:border-orange-500 ${
