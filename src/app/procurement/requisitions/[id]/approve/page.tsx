...
export default function PRApprovalPage() {
  ...
  const calculateTotalCost = () => {
    if (!pr) return 0;
    return pr.items.reduce((total, item) => total + (item.quantity * Number(item.estimatedPrice)), 0);
  };
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-gray-600">
                Review and approve purchase requisition {pr.prNumber}
              </p>
            </div>
            <div className="text-right">
              <span className={`inline-flex px-3 py-1 text-sm font-semibold rounded-full ${getPriorityColor(pr.priority)}`}>
        ...
        <div className="px-6 py-6 space-y-6">
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <dd className="mt-1 text-sm text-gray-900 font-semibold">{pr.prNumber}</dd>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <dd className="mt-1 text-sm text-gray-900">{pr.requesterId}</dd>
                <dd className="text-xs text-gray-500">{pr.departmentId}</dd>
              </div>
            </div>
          ...
          <div>
            ...
            <div className="bg-gray-50 rounded-lg p-4">
              <p className="text-sm text-gray-700">{pr.justification}</p>
            </div>
          </div>
          ...
          <div className="bg-blue-50 rounded-lg p-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <p className="text-sm font-medium text-blue-900">{pr.budgetCode}</p>
              </div>
              <div>
                <span className="text-xs text-blue-700">Item Type</span>
                <p className="text-sm font-medium text-blue-900">{pr.itemType}</p>
              </div>
            </div>
          </div>
                    ...
                    <tr key={item.id} className="hover:bg-gray-50">
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div>
                          ...
                          <div className="text-xs text-gray-400">{item.item.category.nameEn}</div>
                        </div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm font-medium text-gray-900">
                          {formatCurrency(item.quantity * Number(item.estimatedPrice))}
                        </div>
                      </td>
