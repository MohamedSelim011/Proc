    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className={`fixed inset-0 z-50 lg:hidden ${sidebarOpen ? 'block' : 'hidden'}`}>
        ...
        <div className="fixed inset-y-0 left-0 flex w-64 flex-col bg-white">
          <div className="flex items-center justify-between px-6 py-6 bg-gradient-to-r from-orange-500 to-red-500">
      ...
      <div className="hidden lg:fixed lg:inset-y-0 lg:flex lg:w-64 lg:flex-col">
        <div className="flex flex-col flex-grow bg-white shadow-lg border-r border-gray-200">
          {/* Wujha Header */}
          <div className="flex items-center px-6 py-6 bg-gradient-to-r from-orange-500 to-red-500">
            <div className="w-8 h-8 bg-white rounded mr-3 flex items-center justify-center">
              <span className="text-orange-500 font-bold text-sm">W</span>
            </div>
            <div>
