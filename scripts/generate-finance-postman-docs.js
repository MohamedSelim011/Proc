...
function folderForRoute(routePath) {
  ...
  if (parts[1] === 'finance') return parts.length >= 3 ? `finance/${parts[2]}` : 'finance';
...
function generateDocs(endpoints) {
  ...
  lines.push('');
  lines.push('Notes:');
  lines.push('- This documentation is generated by scanning all APIs in `src/app/api/**/route.ts`.');
...
function main() {
  ...
  const postmanCollection = {
    info: {
      ...
      description: 'Auto-generated from all route handlers in src/app/api. Single-import variant with embedded variables.',
