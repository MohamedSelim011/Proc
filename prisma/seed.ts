...
async function main() {
  ...
  // Create vendors with Omani data
  ...
  await Promise.all([
    prisma.vendorCategory.create({
      data: {
        ...
        categoryId: categories[0].id, // Construction
        isPrimary: true,
      },
    }),
    prisma.vendorCategory.create({
      data: {
        ...
        categoryId: categories[4].id, // Oil & Gas
        isPrimary: true,
      },
    }),
    prisma.vendorCategory.create({
  ...
  // Create items with Omani context
